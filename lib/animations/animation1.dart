...
import 'package:flutter_app_1/animations/animation_one_details.dart';
import 'package:flutter_app_1/network_image/network_image.dart';
import 'package:flutter_app_1/assert/core_asserts.dart' as assets;
...
class _AnimationOnePageState extends State<AnimationOnePage>
  ...
  int currentIndex = 0;
  int prevIndex = 0;
  final TextEditingController _swiperController = TextEditingController();
